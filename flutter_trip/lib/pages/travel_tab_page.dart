          ...
          childWidget: RefreshIndicator(
            ...
            child: MediaQuery.removePadding(
                ...
                child: new StaggeredGridView.countBuilder(
                  ...
                  itemBuilder: (BuildContext context, int index) => _TravlItem(index: index, item: travelItems[index],),
...
class _TravlItem extends StatelessWidget {
  final TravelItem item;
  final int index;

  const _TravlItem({Key key, this.item, this.index}) : super(key: key);
